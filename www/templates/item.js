...
var jade_debug = [{ lineno: 1, filename: "www/templates//item.jade" }];
try {
var buf = [];
var jade_mixins = {};
var jade_interp;
...
var jade_indent = [];
jade_debug.unshift({ lineno: 0, filename: "www/templates//item.jade" });
jade_debug.unshift({ lineno: 1, filename: "www/templates//item.jade" });
...
jade_debug.unshift({ lineno: 2, filename: "www/templates//item.jade" });
