...
var jade_debug = [{ lineno: 1, filename: "www/templates//searchResults.jade" }];
try {
var buf = [];
var jade_mixins = {};
var jade_interp;
...
buf.push("</h2>");
jade_debug.shift();
jade_debug.unshift({ lineno: 2, filename: "www/templates//searchResults.jade" });
// iterate items
;(function(){
  var $$obj = items;
...
jade_debug.unshift({ lineno: 2, filename: "www/templates//searchResults.jade" });
jade_debug.unshift({ lineno: 3, filename: "www/templates//searchResults.jade" });
buf.push("\n<div" + (jade.attr("data-file", item.url, true, false)) + (jade.attr("data-id", item.id, true, false)) + (jade.cls(["item "+item.type], [true])) + ">");
jade_debug.unshift({ lineno: undefined, filename: jade_debug[0].filename });
jade_debug.unshift({ lineno: 4, filename: "www/templates//searchResults.jade" });
buf.push("\n  <h3>" + (jade.escape(null == (jade_interp = item.title) ? "" : jade_interp)));
jade_debug.unshift({ lineno: undefined, filename: jade_debug[0].filename });
jade_debug.shift();
buf.push("</h3>");
jade_debug.shift();
jade_debug.unshift({ lineno: 5, filename: "www/templates//searchResults.jade" });
