...
var jade_debug = [{ lineno: 1, filename: "www/templates//navigation.jade" }];
try {
var buf = [];
var jade_mixins = {};
var jade_interp;
...
jade_debug.unshift({ lineno: 2, filename: "www/templates//navigation.jade" });
buf.push("\n  <ul data-role=\"listview\">");
jade_debug.unshift({ lineno: undefined, filename: jade_debug[0].filename });
jade_debug.unshift({ lineno: 3, filename: "www/templates//navigation.jade" });
// iterate categories
;(function(){
  var $$obj = categories;
...
jade_debug.unshift({ lineno: 3, filename: "www/templates//navigation.jade" });
jade_debug.unshift({ lineno: 4, filename: "www/templates//navigation.jade" });
buf.push("\n    <li>");
jade_debug.unshift({ lineno: undefined, filename: jade_debug[0].filename });
jade_debug.unshift({ lineno: 5, filename: "www/templates//navigation.jade" });
