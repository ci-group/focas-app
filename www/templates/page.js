...
buf.push("\n    </div>");
jade_debug.shift();
jade_debug.unshift({ lineno: 27, filename: "www/templates//page.jade" });
buf.push("\n    <div class=\"ui-block-b\">");
jade_debug.unshift({ lineno: undefined, filename: jade_debug[0].filename });
jade_debug.shift();
buf.push("</div>");
