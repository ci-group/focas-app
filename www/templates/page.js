...
buf.push("\n  <div data-role=\"content\" role=\"main\"" + (jade.cls(["ui-main background-"+page.color], [true])) + ">");
jade_debug.unshift({ lineno: undefined, filename: jade_debug[0].filename });
...
buf.push("\n              <div" + (jade.attr("data-file", item.url, true, false)) + (jade.attr("data-id", item.name, true, false)) + (jade.cls(["item "+item.type], [true])) + ">");
jade_debug.unshift({ lineno: undefined, filename: jade_debug[0].filename });
...
buf.push("\n          <div" + (jade.attr("id", "button-"+item.name, true, false)) + (jade.cls(["item-container "+featured], [true])) + ">");
jade_debug.unshift({ lineno: undefined, filename: jade_debug[0].filename });
jade_debug.unshift({ lineno: 30, filename: "templates/client/page.jade" });
buf.push("\n            <div" + (jade.attr("data-id", item.name, true, false)) + (jade.cls(["item "+featured], [true])) + ">");
jade_debug.unshift({ lineno: undefined, filename: jade_debug[0].filename });
...
buf.push("\n            </div>");
jade_debug.shift();
jade_debug.unshift({ lineno: 33, filename: "templates/client/page.jade" });
